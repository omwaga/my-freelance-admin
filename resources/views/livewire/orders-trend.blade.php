<div class="bg-white p-5 shadow-xl rounded" style="width: 26rem">
    ...
    <h2 class="font-bold pb-3 text-center">Orders Trend</h2>
    ...
    <canvas id="ordersTrendChart" width="350" class="mt-5" height="300"></canvas>
    <script>
        let ctx3 = document.getElementById('ordersTrendChart').getContext('2d');
        let ordersChart = new Chart(ctx3, {
            type: 'bar',
            data: {
