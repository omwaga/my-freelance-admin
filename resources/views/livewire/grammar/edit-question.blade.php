<div class="mt-8 mx-auto w-1/2 bg-white rounded-md p-2">
    <form wire:submit.prevent="editQuestion">
        <div class="flex flex-col md:flex-row">
            <div class="form-group mt-3 mb-3 p-2"><label for="question" class="">Question</label><textarea
                    wire:model="question" name="question" id="question" class="border rounded w-full p-2"
                    aria-label="question" required>{{ $question }}</textarea>
                @error('question')
            ...
            <div class="form-group mt-3 mb-3 p-2"><label for="choice-one" class="">Choice 1</label><textarea
                    ...
                    aria-label="question" required>{{ $choice_one }}</textarea>@error('choice_one') <span
        ...
        <div class="flex flex-col md:flex-row">
            <div class="form-group mt-3 mb-3 p-2"><label for="choice-two" class="">Choice 2</label><textarea
                    ...
                    aria-label="question" required>{{ $choice_two }}</textarea>@error('choice_two') <span
                    class="error text-red-400">{{ $message }}</span> @enderror</div>
            <div class="form-group mt-3 mb-3 p-2"><label for="choice-three" class="">Choice 3</label><textarea
                    ...
                    aria-label="question" required>{{ $choice_three }}</textarea>@error('choice_three') <span
                    class="error text-red-400">{{ $message }}</span> @enderror</div>
        </div>
        <div class="flex flex-col md:flex-row">
            <div class="form-group mt-3 mb-3 p-2"><label for="choice-four" class="">Choice 4</label><textarea
                    ...
                    aria-label="question" required>{{ $choice_three }}</textarea>@error('choice_four') <span
                    class="error text-red-400">{{ $message }}</span> @enderror</div>
            <div class="form-group mt-3 mb-3 p-2"><label for="answer" class="">Answer</label><br><select
                    wire:model="answer" name="answer" id="answer" aria-label="answer" class="w-64 rounded p-2">
