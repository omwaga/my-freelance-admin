        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('writers') }}" :active="request()->routeIs('writers')">
                        {{ __('Writers') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('users') }}" :active="request()->routeIs('users')">
                        {{ __('Users') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('grammar-test-management') }}"
                                    :active="request()->routeIs('grammar-test-management')">
                        {{ __('Grammar Test Management') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('money-management') }}"
                                    :active="request()->routeIs('money-management')">
                        {{ __('Money Management') }}
                    </x-jet-nav-link>
