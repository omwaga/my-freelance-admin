<x-app-layout>
    ...
    <div class="container mt-50 p-10">
        <div class="mt-5 mb-5 p-3">
            <div class="flex flex-row">
                <h1 class="pl-5 pr-5 pt-2 pb-2 text-2xl mr-auto">Degrees</h1>
                <div class="mt-5">
                    <a href="/settings/degrees/add"
                       class="bg-blue-500 hover:bg-blue-800 text-white p-2 rounded-sm mt-5">Add Degree</a>
                </div>
            </div>
                ...
                @foreach ($degrees as $index=>$deg)
                    <tr>
                        ...
                        <td class="px-5 py-2 border-b border-gray-200 bg-white text-sm">
                            {{ $deg->name }}</td>
                        <td class="px-5 py-2 border-b border-gray-200 bg-white text-sm">
                            <a href="/settings/degrees/delete/{{{$deg->id}}}"
